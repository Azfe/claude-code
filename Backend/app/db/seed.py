...
def create_sample_data():
    ...
    try:
        ...
        course1 = Course(
            ...
            thumbnail="https://placehold.co/300x200/1a1a2e/61dafb?text=React",
            slug="curso-de-react",
            created_at=datetime.utcnow(),
            updated_at=datetime.utcnow(),
        )
        ...
        course2 = Course(
            ...
            thumbnail="https://placehold.co/300x200/1a1a2e/3776ab?text=Python",
        ...
        course3 = Course(
            ...
            thumbnail="https://placehold.co/300x200/1a1a2e/f7df1e?text=JavaScript",
